...
const HireMe = () => {
  return (
    <div className="fixed -left-12 -bottom-8 flex items-center justify-center overflow-hidden md:hidden">
      <HireMeIcon className="fill-dark w-[17rem] animate-spin-slow dark:fill-light" />
